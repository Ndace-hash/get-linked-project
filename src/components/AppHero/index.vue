      ...
      <div class="flex flex-col items-center gap-2 lg:gap-4 lg:items-start relative">
        ...
        <div class="flex flex-col items-center lg:items-start">
          <div class="relative pt-6 w-max">
            ...
            <img src="@assets/lightbulb.svg" alt="A lightbulb" class="absolute w-6 top-0 right-2 lg:w-7" />
          </div>
          <div class="flex items-center">
            <h1 class="font-clash-display text-desktop-heading-2 leading-tight text-center lg:text-[48px]">
              Hackathon
              <span class="text-secondary-minor">1.0</span>
            </h1>
            <img src="@assets/chainlink.svg" class="inline w-12" />
            <img src="@assets/bang.svg" class="inline w-8" />
          </div>
        </div>
        <p class="text-mobile-paragraph text-center w-4/5 lg:text-left">
        ...
        <div class="flex gap-5 mt-3 lg:mt-6 mb-10">
          <p class="font-unica-one text-desktop-heading-2">
            00<span class="text-sm capitalize">h</span>
          </p>
          <p class="font-unica-one text-desktop-heading-2">
            00<span class="text-sm capitalize">m</span>
          </p>
          <p class="font-unica-one text-desktop-heading-2">
            00<span class="text-sm capitalize">s</span>
          </p>
        </div>
      </div>
      <div class="mt-4 w-full lg:absolute lg:bottom-0 lg:right-0 lg:w-1/2 max-w-[700px] lg:max-w-[500px]">
        <img src="@assets/images/hero.png" alt="a guy wearing a VR headset" class="w-full" />
      </div>
    </div>
  </section>
</template>
