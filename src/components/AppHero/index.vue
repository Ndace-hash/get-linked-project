<template>
    <section id="hero" class="flex flex-col items-center ">
        <div class="flex justify-center lg:justify-end py-4 pt-8 w-max mb-6 relative lg:self-end lg:me-16">
            <h3 class="font-bold capitalize text-desktop-subtext">Igniting a revolution in HR innovation</h3>
        ...
        <div class="flex flex-col items-center lg:flex-row relative w-full lg:ps-20 lg:mt-24">
            <div class="flex flex-col items-center gap-2 lg:gap-4 lg:items-start">
                ...
                <p class="text-mobile-paragraph text-center w-4/5 lg:text-left">Participate in getlinked tech Hackathon 2023
                    stand
            ...
            <div class="mt-4 w-full lg:absolute lg:bottom-0 lg:right-0 lg:w-1/2 max-w-[700px] lg:max-w-[500px]"><img
                    src="../../assets/images/hero.png" alt="a guy wearing a VR headset" class="w-full" />
            </div>
        </div>
    </section>
</template>
