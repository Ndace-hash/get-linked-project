<template>
    <header
        ...
        <button class="flex flex-col w-[30px] gap-1" @click="() => showMenu = true">
            ...
            <span class="h-[4px] bg-white block w-1/2 shrink-0 self-end rounded-sm"></span>
        </button>
        <div
            ...
            <nav class="flex flex-col gap-5 px-14 md:items-center">
                <a href="#" class="capitalize text-desktop-subtext font-medium">Timeline</a>
                <a href="#" class="capitalize text-desktop-subtext font-medium">Overview</a>
                <a href="#" class="capitalize text-desktop-subtext font-medium">FAQs</a>
                <a href="#" class="capitalize text-desktop-subtext font-medium">Contact</a>
                <RouterLink to="/"
            ...
            <button
                class="absolute top-8 right-12 text-4xl text-white font-bold w-[40px] h-[40px] rounded-full flex items-center justify-center bg-gradient-to-t from-primary-one to-primary-two"
                @click="() => showMenu = false">
                <div class="bg-secondary-major rounded-full">
                    <Close />
                </div>
            </button>
        </div>
