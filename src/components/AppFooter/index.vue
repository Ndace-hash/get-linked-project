<template>
    <footer class="bg-footer py-16 md:px-16">
        <div class="flex gap-10 px-12 flex-col md:flex-row w-full">
            <div class="w-1/3 me-6">
                <div class="w-[150px]">
                    <img src="@assets/get_linked.svg" alt="getlinked logo" class="w-full">
                </div>
                <p class="mt-4 text-desktop-paragraph">Getlinked Tech Hackathon is a technology
            ...
            <div class="w-1/3">
                <h3 class="font-bold text-desktop-heading-3 text-secondary-minor capitalize">Useful Links</h3>
            ...
            <div>
                <h3 class="font-bold text-desktop-heading-3 text-secondary-minor capitalize">contact us</h3>
                <div class="flex flex-col gap-4 mt-4">
                    <a href="tel:+23467981819" class="flex items-center gap-4 text-desktop-paragraph"><img
                            src="@/assets/images/phone.svg" alt="phone icon" class="w-[14px]"><span>+234
                            679
                            81819</span></a>
        ...
        <p class="w-full text-center mt-12">All rights reserved. &copy; getlinked Ltd.</p>
