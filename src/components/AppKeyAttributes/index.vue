    ...
    <section id="intro" class="flex flex-col py-8 items-center lg:flex-row lg:justify-center lg:px-20 lg:py-16">
        ...
        <div class="mt-2 px-6 lg:px-3 lg:w-[50%] flex flex-col items-center lg:items-start">
            ...
            <p class=" w-[90%] mx-auto text-center px-1 mt-3 lg:text-left lg:mx-0 text-desktop-paragraph mb-4 lg:w-full"
                ...
                <span class="text-primary-one font-bold text-[16px]">{{ a.attribute }}:</span> {{ a.text }}
            </p>
            <button class="bg-gradient-to-r from-primary-one to-primary-two py-2 px-6 rounded-sm mt-4 w-max">Read
                More</button>
        </div>
    </section>
</template>
