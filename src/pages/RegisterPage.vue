<template>
  <section class="min-h-full flex items-center">
    <div class="hidden lg:flex">
      <img
        src="@assets/images/man_sitting_at_table.svg"
        alt="An illustration of a man sitting at a table with crossed legs"
      />
    </div>
    <div
      class="py-8 px-12 lg:bg-white lg:bg-opacity-5 lg:shadow-md md:mx-auto lg:scale-90 rounded-md"
    >
      <h2
        class="text-secondary-minor font-bold font-clash-display text-desktop-subtext"
      >
        Register
      </h2>
      <div>
      ...
      <p class="flex gap-2 items-end text-desktop-paragraph">
        Be part of this movement!<span
          class="flex items-end border-b-2 border-b-secondary-minor border-dashed w-[80px] justify-center"
          ><img
            src="@assets/images/woman_walking.svg"
            alt="a woman walking" /><img
            src="@assets/images/man_walking.svg"
            alt="a man walking"
        /></span>
      </p>
      ...
      >
        <div class="flex flex-col my-6 gap-4 lg:grid lg:grid-cols-2">
          <div class="flex flex-col gap-2">
            ...
            />
            <p
              v-for="e in v$.team_name.$errors"
              class="text-desktop-paragraph text-primary-one"
          ...
          <div class="flex flex-col gap-2">
            ...
            />
            <p
              v-for="e in v$.phone_number.$errors"
              class="text-desktop-paragraph text-primary-one"
          ...
          <div class="flex flex-col gap-2">
            ...
            />
            <p
              v-for="e in v$.project_topic.$errors"
              class="text-desktop-paragraph text-primary-one"
          ...
          <div class="flex gap-2 lg:gap-4 w-full col-span-2 items-center">
            <div class="flex flex-col gap-2">
              ...
              >
                ...
                <option
                  :value="category.id"
                  class="text-white bg-secondary-major"
            ...
            <div class="flex flex-col gap-2 md:w-1/2">
              <label for="group-size" class="capitalize text-sm"
                >group size</label
              >
              <select
                id="group-size"
              ...
              <p
                v-for="e in v$.group_size.$errors"
                class="text-sm text-primary-one"
                v-if="v$.group_size.$error"
              >
                {{ e.$message }}
              </p>
            </div>
        ...
        <p
          class="text-sm text-primary-one"
          v-if="!formData.privacy_policy_accepted"
        >
    ...
    <div
      class="fixed inset-0 bg-secondary-major bg-opacity-90 flex items-center justify-center px-8"
      v-if="succesfullRegistration"
    >
      <div
        class="border border-secondary-minor rounded-md flex flex-col items-center px-16 py-8"
      >
        ...
        <p
          class="flex flex-col text-center item-end mt-2 lg:text-desktop-paragraph text-[12px]"
        >
          Yes, it was easy and you did it! <br /><span
            class="flex items-end gap-1"
            >check your mail box for next step
            <img src="@assets/images/wink_emoji_woman.svg"
          /></span>
        </p>
        <button
          class="bg-gradient-to-r from-primary-one to-primary-two w-full py-3 rounded-md mt-6"
